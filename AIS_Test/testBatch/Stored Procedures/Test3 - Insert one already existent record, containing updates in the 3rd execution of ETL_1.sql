...
*/
CREATE    PROCEDURE [testBatch].[Test3 - Insert one already existent record, containing updates in the 3rd execution of ETL]
AS
BEGIN
...
/*ASSERT*/
 ...
 -- exec tsqlt.Run @TestName = '[testBatch].[Test3 - Insert one already existent record, containing updates in the 3rd execution of ETL]'
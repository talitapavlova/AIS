...
*/
CREATE  PROCEDURE [testBatch].[Test5 - Insert updates for already existent record, coming with multiple rows]
AS
BEGIN
...
/*ACT*/
  ...
  --values expected to be in utility.Batch after accumulating all executions of the ETL 
	insert into expected_Batch
	values (1,1,1,0,'2020-03-26 16:55:41.0000000',	'2020-03-26 16:55:41.0000000', GETDATE())
	insert into expected_Batch
	values (2,10,1,0,'2020-03-26 16:55:41.0000000',	'2020-03-26 16:55:41.0000000', GETDATE())
...
/*ASSERT*/
 ...
 -- exec tsqlt.Run @TestName = '[testBatch].[Test4 - Insert updates for already existent record, coming with multiple rows]'
...
CREATE      PROCEDURE [testDimVessel].[Test4 - Insert already existing records containing no updates]
AS
BEGIN
 ...
 -- exec tsqlt.Run @TestName = '[testDimVessel].[Test4 - Insert already existing records containing no updates]'
...
/******
	...
	Test07 - Insert updates to already existent record for all ETA attributes
			 ...
			 The already existent record contains all voyage information (Destination and ETA attributes are having values)
...
CREATE PROCEDURE [testDimVoyage].[Test07 - Insert updates to already existent record for all ETA attributes]
AS
BEGIN
/*ARRANGE*/ 
...
/*ACT*/
	...
	execute [extract].[AIS_Data_CSV]'C:\AIS\Tests\test_DimVoyage\Test7.csv'
    ...
    insert into expected values ( 1, '370424000', '2020-03-26 16:55:41.0000000', '2020-05-08 10:11:07.0000000', 4, 3, 5 , 3, 'Aarhus' , 1, 2, 1)
...
/*ASSERT*/ 
  ...
  -- evaluate if the expected table matches the actual table
   ...
   --exec tsqlt.Run @TestName = '[testDimVoyage].[Test07 - Insert updates to already existent record for all ETA attributes]'
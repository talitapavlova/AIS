...
/******
	...
	[Test08 - Insert updates coming as NULLs to already existent record containing values for all ETA attributes.]
		     The test performs the ETL targeting Dim_Voyage as well as other dependent stored procedures. 
			 The source file contains updates as NULL values regarding voyage information of already existent record. 
			 The already existent record contains voyage information( Destination  and ETA information)
			 The test verifies that the Voyage record is updated. 
	...
	CSV content:
			...
			370424000|5|7.625225|56.562680|370|Panama (Republic of)|0|-11|12,3|1|209,7|209|0|0|0|08-05-2020 10:11:07|ANTIGUA|9783071|SMPA@@@|70|54|146|200|17|15|32|15|||||6,5|Aarhus

*/

CREATE   PROCEDURE [testDimVoyage].[Test08 - Insert updates coming as 'NULLs' to already existent record containing values for all 'ETA' attributes]
AS
BEGIN
/*ARRANGE*/ 
  ...
  -- truncate tables to have accurate test results 
   ...
   --Prepare Dim_Voyage table to be pre-populated with 1 records, simulting a previous execution of the ETL
	...
	values ( '370424000', '2020-03-26 16:55:41.0000000', '2020-03-26 16:55:41.0000000', 4, 4, 4, 4, 'Aarhus' , 1, 1, 1)

/*ACT*/
	-- ETL for Dim_Vessel to insert the following CSV. file records, consisting of 1 record in Dim_Vessel
	execute [extract].[AIS_Data_CSV]'C:\AIS\Tests\test_DimVoyage\Test8.csv'
    ...
    insert into expected values ( 1, '370424000', '2020-03-26 16:55:41.0000000', '2020-05-08 10:11:07.0000000', null, null, null , null, 'Aarhus' , 1,2, 1)
...
/*ASSERT*/ 
  ...
  -- evaluate if the expected table matches the actual table
   ...
   --exec tsqlt.Run @TestName = '[testDimVoyage].[Test08 - Insert updates coming as ''NULLs'' to already existent record containing values for all ''ETA'' attributes]'
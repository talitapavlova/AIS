...
/******
    ...
    [Test04 - Insert route info for different destinations of the same vessel, coming in the same batch]
			 ...
			 The test verifies if the Fact_Route is cross-referencing the correct Dim_voyage record corresponding to each destination, by assessing if the expected values match the actual Fact_Route
...
/*ACT*/
	...
	insert into expected values ( 1, 20200508, 111230, 58328081, 11133831, 0, 2, 0, 0.60, 330.00, 285, 1, 0, 0, null,1)
